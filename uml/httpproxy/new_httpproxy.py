...
class HTTPProxyHandler (BaseHTTPServer.BaseHTTPRequestHandler) :
    ...
    def sendPage (self, id) :
        ...
        # database, but we don't want to do that, we want to better handle 
        # it or at least log it.
    ...
    def retrieve (self, method) :
        ...
        scraperID, runID, cacheFor = 1, None, 0 #self.ident ()
...
#            return
        ...
        #
        # cached[2] is no longer used as it is handled by memcache timeout
        ...
        if   fetched is not None : cacheid, page = ctag, fetched
        elif cached  is not None : cacheid, page = ctag,  cached
        else                     : cacheid, page = '', ''
