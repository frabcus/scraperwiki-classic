...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserScraperEditing.scraper'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['scraper.Scraper'], null=True))
        db.alter_column('scraper_userscraperediting', 'scraper_id', orm['scraper.userscraperediting:scraper'])
        
        # Changing field 'UserScraperEditing.user'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['auth.User'], null=True))
        db.alter_column('scraper_userscraperediting', 'user_id', orm['scraper.userscraperediting:user'])
        
        # Changing field 'Scraper.language'
        # (to signature: django.db.models.fields.CharField(default='Python', max_length=32))
        db.alter_column('scraper_scraper', 'language', orm['scraper.scraper:language'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserScraperEditing.scraper'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['scraper.Scraper']))
        db.alter_column('scraper_userscraperediting', 'scraper_id', orm['scraper.userscraperediting:scraper'])
