...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.language'
        db.add_column('scraper_scraper', 'language', orm['scraper.Scraper:language'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.language'
        db.delete_column('scraper_scraper', 'language')
