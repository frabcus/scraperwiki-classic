...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('scraper_scraper', 'scraper_sparkline_csv', orm['scraper.scraper:scraper_sparkline_csv'])
        
        # Adding field 'Scraper.has_geo'
        db.add_column('scraper_scraper', 'has_geo', orm['scraper.scraper:has_geo'])
        
        # Adding field 'Scraper.has_temporal'
        db.add_column('scraper_scraper', 'has_temporal', orm['scraper.scraper:has_temporal'])
        
        # Adding field 'Scraper.line_count'
        db.add_column('scraper_scraper', 'line_count', orm['scraper.scraper:line_count'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('scraper_scraper', 'scraper_sparkline_csv')
        
        # Deleting field 'Scraper.has_geo'
        db.delete_column('scraper_scraper', 'has_geo')
        
        # Deleting field 'Scraper.has_temporal'
        db.delete_column('scraper_scraper', 'has_temporal')
        
        # Deleting field 'Scraper.line_count'
        db.delete_column('scraper_scraper', 'line_count')
