...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('scraper_scrapermetadata', (
            ('id', orm['scraper.ScraperMetadata:id']),
            ('name', orm['scraper.ScraperMetadata:name']),
            ('scraper', orm['scraper.ScraperMetadata:scraper']),
            ('run_id', orm['scraper.ScraperMetadata:run_id']),
            ('value', orm['scraper.ScraperMetadata:value']),
        ))
        db.send_create_signal('scraper', ['ScraperMetadata'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('scraper_scrapermetadata')
