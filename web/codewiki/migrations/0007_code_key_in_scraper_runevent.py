...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScraperRunEvent.code'
        db.add_column('codewiki_scraperrunevent', 'code', orm['codewiki.scraperrunevent:code'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScraperRunEvent.code'
        db.delete_column('codewiki_scraperrunevent', 'code_id')
    ...
    models = {
        ...
        'codewiki.code': {
            ...
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'}),
