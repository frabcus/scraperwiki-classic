...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [twisterclientnumber] on UserScraperEditing.
        db.create_unique('scraper_userscraperediting', ['twisterclientnumber'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [twisterclientnumber] on UserScraperEditing.
        db.delete_unique('scraper_userscraperediting', ['twisterclientnumber'])
