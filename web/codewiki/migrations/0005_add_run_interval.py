...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.run_interval'
        db.add_column('scraper_scraper', 'run_interval', orm['scraper.scraper:run_interval'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.run_interval'
        db.delete_column('scraper_scraper', 'run_interval')
