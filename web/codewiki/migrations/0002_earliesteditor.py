...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodeCommitEvent.earliesteditor'
        db.add_column('codewiki_codecommitevent', 'earliesteditor', orm['codewiki.codecommitevent:earliesteditor'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CodeCommitEvent.earliesteditor'
        db.delete_column('codewiki_codecommitevent', 'earliesteditor')
    ...
    models = {
        ...
        'codewiki.codecommitevent': {
            'earliesteditor': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
