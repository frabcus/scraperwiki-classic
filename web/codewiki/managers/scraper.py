...
class ScraperManager(CodeManager):
    ...
    def NEWPROXYCODE_clear_datastore(self, scraper_id):
    ...
    def NEWPROXYCODE_data_dictlist(self, scraper_id, limit=1000, offset=0, start_date=None, end_date=None, latlng=None):   
