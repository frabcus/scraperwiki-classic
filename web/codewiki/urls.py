...
urlpatterns = patterns('',
    ...
    url(r'^(?P<wiki_type>scraper|view)s/new/(?P<language>[\w]+)/tovault/(?P<id>\d+)/$', lambda request, wiki_type, language: HttpResponseRedirect('https://scraperwiki.com'), name="add_to_vault"),
