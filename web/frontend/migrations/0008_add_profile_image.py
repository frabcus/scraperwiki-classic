...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('frontend_userprofile', 'thumbnail', orm['frontend.userprofile:thumbnail'])
        
        # Adding field 'UserProfile.photo'
        db.add_column('frontend_userprofile', 'photo', orm['frontend.userprofile:photo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('frontend_userprofile', 'thumbnail')
        
        # Deleting field 'UserProfile.photo'
        db.delete_column('frontend_userprofile', 'photo')
