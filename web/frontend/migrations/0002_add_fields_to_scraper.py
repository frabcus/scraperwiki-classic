...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.disabled'
        db.add_column('frontend_scraper', 'disabled', orm['frontend.scraper:disabled'])
        
        # Adding field 'Scraper.status'
        db.add_column('frontend_scraper', 'status', orm['frontend.scraper:status'])
        
        # Adding field 'Scraper.deleted'
        db.add_column('frontend_scraper', 'deleted', orm['frontend.scraper:deleted'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.disabled'
        db.delete_column('frontend_scraper', 'disabled')
        
        # Deleting field 'Scraper.status'
        db.delete_column('frontend_scraper', 'status')
        
        # Deleting field 'Scraper.deleted'
        db.delete_column('frontend_scraper', 'deleted')
