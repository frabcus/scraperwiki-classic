...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScraperHistory'
        db.create_table('scraper_scraperhistory', (
            ('id', orm['scraper.scraperhistory:id']),
            ('scraper', orm['scraper.scraperhistory:scraper']),
            ('message_key', orm['scraper.scraperhistory:message_key']),
            ('message_value', orm['scraper.scraperhistory:message_value']),
            ('meta', orm['scraper.scraperhistory:meta']),
            ('message_level', orm['scraper.scraperhistory:message_level']),
            ('datetime', orm['scraper.scraperhistory:datetime']),
        ))
        db.send_create_signal('scraper', ['ScraperHistory'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ScraperHistory'
        db.delete_table('scraper_scraperhistory')
    ...
    models = {
        ...
        'scraper.scraperhistory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
