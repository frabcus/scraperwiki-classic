...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Renaming column for field 'message_type'.
        db.rename_column('scraper_scraperhistory', 'message_type', 'message_type_id')
        
        # Changing field 'ScraperHistory.message_type'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['frontend.AlertTypes']))
        db.alter_column('scraper_scraperhistory', 'message_type_id', orm['scraper.scraperhistory:message_type'])
    ...
    def backwards(self, orm):
        ...
        # Renaming column for field 'message_type'.
        db.rename_column('scraper_scraperhistory', 'message_type_id', 'message_type')
