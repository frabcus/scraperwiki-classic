...
<?xml version="1.0" encoding="UTF-8"?> <successful_payment_notification> <account> <account_code>3-test-20120424T152301</account_code> <username nil="true"></username> <email>test@testerson.com</email> <first_name>Test</first_name> <last_name>Testerson</last_name> <company_name></company_name> </account> <transaction> <id>18582a537a05caeabd49944608aff282</id> <invoice_id>18582a535e93a28b1473734d758a9b0e</invoice_id> <invoice_number type="integer">1325</invoice_number> <action>purchase</action> <date type="datetime">2012-04-25T11:59:44Z</date> <amount_in_cents type="integer">1080</amount_in_cents> <status>success</status> <message>Test Gateway: Successful test transaction</message> <reference>12345</reference> <source>transaction</source> <cvv_result code="M">Match</cvv_result> <avs_result code="D">Street address and postal code match.</avs_result> <avs_result_street>Y</avs_result_street> <avs_result_postal>Y</avs_result_postal> <test type="boolean">true</test> <voidable type="boolean">true</voidable> <refundable type="boolean">true</refundable> </transaction> </successful_payment_notification>
"""
...
def it_translates_successful_payment_in_to_invoice_object():
    ...
    assert_equals(xero_invoice.invoice_number, 'RECURLY1325')
