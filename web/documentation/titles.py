...
page_titles = {
    ...
    "ruby_csv_guide" : ("CSV topic guide","Getting data from comma-separated value files in Ruby"),
    ...
    "python_csv_guide" : ("CSV topic guide","Getting data from comma-separated value files in Python"),
    ...
    "php_csv_guide" : ("CSV topic guide","Getting data from comma-separated value files in PHP"),
