...
page_titles = {
    ...
    "ruby_datastore_guide" : ("Datastore guide","A guide to the ScraperWiki SQL datastore for Ruby programmers"),
    ...
    "python_datastore_guide" : ("Datastore guide","A guide to the ScraperWiki SQL datastore for Python programmers"),
