...
page_titles = {
    ...
    "ruby_csv_guide" : ("CSV copy & paste guide","Getting data from comma-separated value files in Ruby"),
    ...
    "python_help_documentation" : ("ScraperWiki library functions","All the functions in the Python scraperwiki module"),
    ...
    "python_csv_guide" : ("CSV copy & paste guide","Getting data from comma-separated value files in Python"),
    ...
    "php_help_documentation" : ("ScraperWiki library functions","All the functions in the PHP scraperwiki namespace"),
    ...
    "php_csv_guide" : ("CSV copy & paste guide","Getting data from comma-separated value files in PHP"),
