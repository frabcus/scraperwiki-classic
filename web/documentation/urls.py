...
urlpatterns = patterns('',
   ...
   url(r'^(?P<language>(python|ruby|php|shared))/tutorials/$',views.tutorials, name="tutorials"),      
   url(r'^(?P<language>(python|ruby|php|shared))/(?P<path>[\w_\-\.]+)/$',views.docmain, name="docs"),   
