...
urlpatterns = patterns('',
   ...
   url(r'^show/(?P<scraper_short_name>[\w_\-]+)/map/$', views.map, name='scraper_map'),                                              
   url(r'^show/(?P<scraper_short_name>[\w_\-]+)/data/$', views.data, name='scraper_data'),                       
   url(r'^show/(?P<scraper_short_name>[\w_\-]+)/code/$', views.code, name='scraper_code'),
   url(r'^show/(?P<scraper_short_name>[\w_\-]+)/history/$', views.history, name='scraper_history'),
