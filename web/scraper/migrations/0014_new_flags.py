...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.istutorial'
        db.add_column('scraper_scraper', 'istutorial', orm['scraper.scraper:istutorial'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('scraper_scraper', 'istutorial')
        
        # Deleting field 'Scraper.isstartup'
        db.delete_column('scraper_scraper', 'isstartup')
