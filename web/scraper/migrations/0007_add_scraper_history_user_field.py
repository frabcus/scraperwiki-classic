...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScraperHistory.user'
        db.add_column('scraper_scraperhistory', 'user', orm['scraper.scraperhistory:user'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScraperHistory.user'
        db.delete_column('scraper_scraperhistory', 'user_id')
