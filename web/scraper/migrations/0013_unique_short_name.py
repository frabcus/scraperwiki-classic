...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [short_name] on Scraper.
        db.create_unique('scraper_scraper', ['short_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [short_name] on Scraper.
        db.delete_unique('scraper_scraper', ['short_name'])
