...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserScraperEditing'
        db.create_table('scraper_userscraperediting', (
            ('id', orm['scraper.userscraperediting:id']),
            ('user', orm['scraper.userscraperediting:user']),
            ('scraper', orm['scraper.userscraperediting:scraper']),
            ('editingsince', orm['scraper.userscraperediting:editingsince']),
            ('runningsince', orm['scraper.userscraperediting:runningsince']),
            ('closedsince', orm['scraper.userscraperediting:closedsince']),
            ('twisterclientnumber', orm['scraper.userscraperediting:twisterclientnumber']),
            ('twisterscraperpriority', orm['scraper.userscraperediting:twisterscraperpriority']),
        ))
        db.send_create_signal('scraper', ['UserScraperEditing'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserScraperEditing'
        db.delete_table('scraper_userscraperediting')
