...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.record_count'
        db.add_column('scraper_scraper', 'record_count', orm['scraper.scraper:record_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.record_count'
        db.delete_column('scraper_scraper', 'record_count')
