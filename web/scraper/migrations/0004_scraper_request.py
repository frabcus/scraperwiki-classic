...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScraperRequest'
        db.create_table('scraper_scraperrequest', (
            ('id', orm['scraper.scraperrequest:id']),
            ('description', orm['scraper.scraperrequest:description']),
            ('source_link', orm['scraper.scraperrequest:source_link']),
            ('user', orm['scraper.scraperrequest:user']),
            ('created_at', orm['scraper.scraperrequest:created_at']),
        ))
        db.send_create_signal('scraper', ['ScraperRequest'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ScraperRequest'
        db.delete_table('scraper_scraperrequest')
