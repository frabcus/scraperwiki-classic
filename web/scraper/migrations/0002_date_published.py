...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.first_published_at'
        db.add_column('scraper_scraper', 'first_published_at', orm['scraper.scraper:first_published_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.first_published_at'
        db.delete_column('scraper_scraper', 'first_published_at')
