...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scraper.last_run'
        db.add_column('scraper_scraper', 'last_run', orm['scraper.scraper:last_run'])
        
        # Adding field 'Scraper.source'
        db.add_column('scraper_scraper', 'source', orm['scraper.scraper:source'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Scraper.last_run'
        db.delete_column('scraper_scraper', 'last_run')
        
        # Deleting field 'Scraper.source'
        db.delete_column('scraper_scraper', 'source')
    ...
    models = {
        ...
        'scraper.scraper': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_run': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
