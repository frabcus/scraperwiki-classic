...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScraperHistory.message_type'
        db.add_column('scraper_scraperhistory', 'message_type', orm['scraper.scraperhistory:message_type'])
        
        # Deleting field 'ScraperHistory.message_key'
        db.delete_column('scraper_scraperhistory', 'message_key')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScraperHistory.message_type'
        db.delete_column('scraper_scraperhistory', 'message_type')
        
        # Adding field 'ScraperHistory.message_key'
        db.add_column('scraper_scraperhistory', 'message_key', orm['scraper.scraperhistory:message_key'])
